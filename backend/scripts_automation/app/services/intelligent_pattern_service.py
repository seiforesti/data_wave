    ...
    async def detect_patterns(
        ...
        try:
            ...
            if pattern_types is None:
                pattern_types = [
                    PatternRecognitionType.STRUCTURAL,
                    PatternRecognitionType.BEHAVIORAL,
                    PatternRecognitionType.SEMANTIC,
            ...
            for pattern_type in pattern_types:
                if pattern_type == PatternRecognitionType.STRUCTURAL:
                ...
                elif pattern_type == PatternRecognitionType.SEMANTIC:
                    detection_tasks.append(
