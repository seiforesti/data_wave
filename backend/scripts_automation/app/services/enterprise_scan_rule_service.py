...
async def get_enterprise_rule_engine() -> EnterpriseIntelligentRuleEngine:
    """Get or create the global enterprise rule engine instance."""
    global enterprise_rule_engine
    
    if enterprise_rule_engine is None:
        enterprise_rule_engine = EnterpriseIntelligentRuleEngine()
        await enterprise_rule_engine.initialize()
    
    return enterprise_rule_engine
