...
class Workflow(SQLModel, table=True):
    ...
    # Workflow definition
    definition: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    retry_policy: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    resource_requirements: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    performance_targets: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    predictive_scaling: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    
    # Governance and compliance
    governance_policies: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    compliance_requirements: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    ...
    dependencies: List["WorkflowDependency"] = Relationship(back_populates="workflow", foreign_keys="[WorkflowDependency.workflow_id]")
...
class WorkflowStep(SQLModel, table=True):
    ...
    input_parameters: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    output_parameters: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    custom_resources: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    
    # AI-powered features
    ai_assisted_configuration: bool = Field(default=False)
    auto_parameter_tuning: bool = Field(default=False)
    performance_optimization: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    
    # Data and security
    data_access_requirements: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    security_context: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
...
class WorkflowExecution(SQLModel, table=True):
    ...
    trigger_data: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    # Results and output
    output_data: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    artifacts_generated: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    data_products_created: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    
    # Error handling
    error_message: Optional[str] = None
    error_details: Optional[Dict[str, Any]] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    retry_count: int = Field(default=0)
    
    # Quality and validation
    quality_score: Optional[float] = Field(ge=0.0, le=1.0)
    validation_results: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    data_quality_checks: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
...
class StepExecution(SQLModel, table=True):
    ...
    # Input/Output
    input_data: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    output_data: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
...
class WorkflowDependency(SQLModel, table=True):
    ...
    # Relationships
    workflow: Optional["Workflow"] = Relationship(foreign_keys="[WorkflowDependency.workflow_id]")
...
class WorkflowTemplate(SQLModel, table=True):
    ...
    # Template definition
    template_definition: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    parameters: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    default_values: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    contributors: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    
    # Version control
    version: str = Field(default="1.0.0")
    changelog: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    
    # Documentation
    documentation: Optional[str] = None
    examples: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    best_practices: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
...
class WorkflowSchedule(SQLModel, table=True):
    ...
    optimal_execution_time: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    blackout_periods: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    ...
    notification_channels: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
