...
from .compliance_models import ComplianceRule, ComplianceFramework
...
class ClassificationRule(SQLModel, table=True):
    ...
    compliance_rule_id: Optional[int] = Field(default=None, foreign_key="compliance_rules.id")
    ...
    compliance_rule: Optional["ComplianceRule"] = Relationship()
    parent_rule: Optional["ClassificationRule"] = Relationship(back_populates="child_rules", remote_side="ClassificationRule.id")
...
class ClassificationDictionary(SQLModel, table=True):
    ...
    # Relationships
    parent_dictionary: Optional["ClassificationDictionary"] = Relationship(back_populates="child_dictionaries", remote_side="ClassificationDictionary.id")
...
class ClassificationResult(SQLModel, table=True):
    ...
    inherited_from: Optional["ClassificationResult"] = Relationship(back_populates="child_results", remote_side="ClassificationResult.id")
...
ClassificationAuditLog.model_rebuild()
ClassificationTag.model_rebuild()
DataSourceClassificationSetting.model_rebuild()
ScanResultClassification.model_rebuild()
CatalogItemClassification.model_rebuild()