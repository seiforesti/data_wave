...
class AnalyticsDataset(SQLModel, table=True):
    ...
    ml_model_compatibility: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
...
class DataCorrelation(SQLModel, table=True):
    ...
    confidence_interval: Dict[str, float] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    
    # Temporal analysis
    temporal_stability: Optional[float] = Field(ge=0.0, le=1.0)
    seasonal_patterns: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
...
class AnalyticsInsight(SQLModel, table=True):
    ...
    title: str
    description: str
    technical_details: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    action_items: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    ...
    user_feedback: Optional[Dict[str, Any]] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
...
class MLModel(SQLModel, table=True):
    ...
    # Advanced metrics
    feature_importance: Dict[str, float] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    model_explainability: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    bias_metrics: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    fairness_score: Optional[float] = Field(ge=0.0, le=1.0)
    
    # Training details
    training_data_size: Optional[int] = None
    training_duration_minutes: Optional[int] = None
    hyperparameters: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    cross_validation_scores: List[float] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    ...
    risk_assessment: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    compliance_checks: Dict[str, bool] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
...
class AnalyticsExperiment(SQLModel, table=True):
    ...
    hypothesis: str
    success_metrics: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    ...
    # Results
    results: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
