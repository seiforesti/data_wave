...
class PerformanceMetric(SQLModel, table=True):
    ...
    # Relationships
    performance_alerts: List["PerformanceAlert"] = Relationship(back_populates="metric")
...
class PerformanceHistory(SQLModel, table=True):
    ...
    metric_id: str = Field(foreign_key="performance_metrics.metric_id", index=True, description="Associated metric")
    ...
    # Relationships
    metric: Optional[PerformanceMetric] = Relationship(back_populates="historical_data")
...
class PerformanceAlert(SQLModel, table=True):
    ...
    # Relationships
    metric: Optional[PerformanceMetric] = Relationship(back_populates="performance_alerts")
