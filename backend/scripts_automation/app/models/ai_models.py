...
from .classification_models import (
    ClassificationBaseModel, SensitivityLevel, ConfidenceLevel, 
...
class AIMessage(ClassificationBaseModel, table=True):
    ...
    __table_args__ = (
        ...
        Index("idx_ai_message_created", "created_at"),
    )
...
class AIPrediction(ClassificationBaseModel, table=True):
    ...
    confidence_level: ConfidenceLevel = Field(sa_column=Column(SQLEnum(ConfidenceLevel)))
    ...
    __table_args__ = (
        ...
        Index("idx_ai_prediction_created", "created_at"),
        Index("idx_ai_prediction_confidence", "confidence_score"),
    )

# Advanced AI Feedback and Learning
class AIFeedback(ClassificationBaseModel, table=True):
...
class AIExperiment(ClassificationBaseModel, table=True):
...
class AIExperimentRun(ClassificationBaseModel, table=True):
...
class AIKnowledgeBase(ClassificationBaseModel, table=True):
...
class AIModelMonitoring(ClassificationBaseModel, table=True):
...
class AIInsight(ClassificationBaseModel, table=True):
