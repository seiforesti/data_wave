...
class SecurityVulnerability(SQLModel, table=True):
    ...
    affected_components: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
...
class SecurityScan(SQLModel, table=True):
    ...
    # Results storage
    scan_results: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
...
class SecurityIncident(SQLModel, table=True):
    ...
    affected_systems: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    
    # Response
    response_actions: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
