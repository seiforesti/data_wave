...
class RuleReview(SQLModel, table=True):
    ...
    decision_rationale: Optional[Text] = Field(default=None)
...
class RuleComment(SQLModel, table=True):
    ...
    content: Text
    formatted_content: Optional[Text] = Field(default=None)  # HTML/Markdown formatted
    ...
    code_snippet: Optional[Text] = Field(default=None)
    
    # Suggestions and Recommendations
    is_suggestion: bool = Field(default=False)
    suggested_change: Optional[Text] = Field(default=None)
    change_rationale: Optional[Text] = Field(default=None)
...
class ApprovalWorkflow(SQLModel, table=True):
    ...
    workflow_description: Optional[Text] = Field(default=None)
    ...
    # Business Context
    business_justification: Optional[Text] = Field(default=None)
    risk_assessment: Dict[str, Any] = Field(default_factory=dict, sa_column=Column(JSON))
...
class ExpertConsultation(SQLModel, table=True):
    ...
    current_approach: Optional[Text] = Field(default=None)
    ...
    expert_recommendations: Optional[Text] = Field(default=None)
    solution_approach: Optional[Text] = Field(default=None)
    implementation_plan: Optional[Text] = Field(default=None)
    ...
    expert_feedback: Optional[Text] = Field(default=None)
    client_feedback: Optional[Text] = Field(default=None)
    ...
    # Relationships
    knowledge_article: Optional[KnowledgeBase] = Relationship(back_populates="consultations")
