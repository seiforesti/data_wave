...
class Workspace(SQLModel, table=True):
    ...
    version_control_integration: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    
    # Governance and compliance
    data_governance_policy: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    usage_analytics: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    productivity_metrics: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    collaboration_score: Optional[float] = Field(ge=0.0, le=1.0)
    
    # Integration settings
    external_integrations: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    webhook_urls: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
...
class WorkspaceMember(SQLModel, table=True):
    ...
    custom_permissions: Dict[str, bool] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    ...
    # Preferences
    notification_preferences: Dict[str, bool] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    workspace_preferences: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
...
class CollaborativeDocument(SQLModel, table=True):
    ...
    current_editors: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    edit_lock: Optional[str] = None  # user_id who has edit lock
    
    # Advanced collaboration features
    real_time_cursors: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    comments: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    suggestions: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    change_tracking: bool = Field(default=True)
    
    # AI-powered features
    ai_insights: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
    auto_completion_enabled: bool = Field(default=True)
    smart_suggestions: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    
    # Data lineage and dependencies
    data_sources: List[int] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    dependencies: List[int] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    output_artifacts: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    ...
    sharing_settings: Dict[str, Any] = Field(default_factory=dict, sa_column_kwargs={"type_": "JSON"})
...
class DocumentVersion(SQLModel, table=True):
    ...
    # Change tracking
    changes: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
...
class Discussion(SQLModel, table=True):
    ...
    topic_classification: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    
    # Related content
    related_documents: List[int] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    related_data_sources: List[int] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
...
class DiscussionReply(SQLModel, table=True):
    ...
    attachments: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
    code_snippets: List[Dict[str, Any]] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
...
class KnowledgeBase(SQLModel, table=True):
    ...
    semantic_embeddings: Optional[List[float]] = Field(default=None, sa_column_kwargs={"type_": "JSON"})
    related_topics: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
...
class CollaborationEvent(SQLModel, table=True):
    ...
    broadcast_to_users: List[str] = Field(default_factory=list, sa_column_kwargs={"type_": "JSON"})
