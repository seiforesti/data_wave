...
class MLTrainingDataset(ClassificationBaseModel, table=True):
    ...
    __table_args__ = (
        ...
        Index("idx_ml_dataset_active", "is_active"),
    )
...
class MLFeedback(ClassificationBaseModel, table=True):
...
class MLExperiment(ClassificationBaseModel, table=True):
...
class MLExperimentRun(ClassificationBaseModel, table=True):
...
class MLFeatureStore(ClassificationBaseModel, table=True):
    ...
    __table_args__ = (
        ...
        Index("idx_ml_feature_active", "is_active"),
    )

# ML Model Performance Monitoring
class MLModelMonitoring(ClassificationBaseModel, table=True):
