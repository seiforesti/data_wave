...
import { Edit, FileText, Mail, Filter, CalendarDays } from "lucide-react"
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>Update the properties for this compliance report.</DialogDescription>
        </DialogHeader>
